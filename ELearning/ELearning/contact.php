...
<div class="container mt-4" id="Contact">  <!--Start Contact Us Container-->
      ...
      <div class="row">  <!--Start Contact Us Row-->
        ...
        <div class="col-md-4 stripe text-white text-center">  <!-- Start Contact Us 2nd Column-->
          <h4>AC sir classes</h4>
          <p> 
          Phone: +91 7595978583<br>
          9b tara Shankar sarani<br>
          Near Tala Thana and Belgachia metro station <br>
          Nearest landmark: Tala Protyoi Durga Pujo <br>
          Belgachia <br>
          Kolkata 700037<br>
          West Bengal <br>
