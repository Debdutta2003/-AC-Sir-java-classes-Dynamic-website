...
<html lang="en">
  <head>
    ...
    <title>AC sir classes</title>
  </head>
  <body>
     <!-- Start Nagigation -->
     <nav class="navbar navbar-expand-sm navbar-dark pl-5 fixed-top">
      <a href="index.php" class="navbar-brand"><i class="fa fa-book me-3"></i>AC sir classes</a>
      <span class="navbar-text">"Learn. Code. Succeed: Expert Tech Tutoring Awaits"</span>
