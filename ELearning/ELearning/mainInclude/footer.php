    ...
    </div> <!-- End Student Registration Modal --><!-- Start Footer -->
 <footer class="container-fluid bg-dark text-center p-2">
    <small class="text-white">Copyright &copy; 2024 || Designed By <a href=https://www.linkedin.com/in/debdutta-banerjee-213aa21b4>Debdutta Banerjee ||</a> <?php   
